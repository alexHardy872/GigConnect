...
namespace GigConnect.Services
{
    public static class GeoCode
    {
        ...
        public static async Task<string[]> GetLatLongFromApi(Location locationIn)
        {
            ...
            string requestUri = string.Format("https://maps.googleapis.com/maps/api/geocode/json?address={0}&key={1}", Uri.EscapeDataString(formattedAddress), Keys.googleMapsApiKey);
